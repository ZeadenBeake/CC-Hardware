...
-- EDIT: Modified bios by CC:Hardware to support directly checking computer cases for normal/advanced families
...
local ok, err = pcall(parallel.waitForAny,
    function()
        ...
        if _ccHardware and not _ccHardware.advanced() then
            multishell = nil
        end
        os.run({}, sShell)
