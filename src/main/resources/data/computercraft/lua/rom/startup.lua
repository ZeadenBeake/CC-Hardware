...
-- EDIT: Modified by CC:Hardware to correctly set path based on case being normal or advanced.

local completion = require "cc.shell.completion"

-- Setup paths
local sPath = ".:/rom/programs:/rom/programs/http"
local isAdvanced = (_ccHardware ~= nil and _ccHardware.advanced()) or (_ccHardware == nil and term.isColor())
if isAdvanced then
